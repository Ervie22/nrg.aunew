          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                  <h3 class="slide-item__title">5G – A Superfast Mobile Technology <br> that drives the Digital Glob</h3>
                 </div>
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="assets/images/technology/blog4.jpg" alt="" style="border-radius: 50%;">
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="post-item">
              <div class="position-relative">
                <div class="post-item__img">
                  <a href="#">
                    <img src="assets/images/technology/blog4.jpg" alt="blog image">
                  </a>
                </div><!-- /.post-img -->
              ...
              <h2 class="post-item__title">
                5G – A Superfast Mobile Technology that drives the Digital Glob
              </h2>
              <div class="post-item__desc">
				...
				<p>5G or Superfast Fifth Generation mobile network technology is already on the go which goes far beyond faster browsing and quality calls. 5G more than just a faster network brings new capabilities that will create new opportunities for businesses, society, and People. The first step in unlocking it is by understanding its potential. It acts as the bridge between the people and the future.</p>

				<p>So, what is 5G?</p>

				<p>What difference will the 5G Network make to our lives?</p>

				<h3>To put it simply: a lot</h3>

				<p>Smarter electricity, Industrial IoT, connected vehicles, Logistics networks, cloud technologies, smart communities, captivating education— all will rely on Fifth Generation networks.</p>

				<p>Here is everything you need to know about 5G.</p>

				<h3>What is 5G?</h3>
				<p>5G is the Fifth generation of Mobile networks after the series of global wireless standards such as 1G, 2G, 3G, and 4G. Unlike earlier generations of cellular technology which just only focused on establishing connectivity, 5G takes it to the next level by connecting virtually everything including peoples, devices, machines, etc by delivering higher performance with improved efficiency empowering more uniform user experiences.</p>

				<p>With higher capacity, 5G delivers multi-Gbps peak data speeds up to 20 Gbps, ultra-low latency, and powers innovation that would have been impossible with a 4G network.</p>

				<h3>What Technologies Makeup 5G?</h3>

				<p>5G is based on orthogonal frequency-division multiplexing (OFDM) which is a method to modulate a digital signal across various channels to cut down interference. It also uses a 5G New Radio (NR) air interface parallel to OFDM principles.</p>

				<p>5G operates the same as 4G LTE mobile networking principles but the new 5G NR air interface will enhance OFDM that helps 5G Network to deliver higher flexibility and scalability. 5G runs on the same radio frequencies which are currently being used on our smartphones, on Wi-Fi networks, and in satellite communications, but it advances and elevates technology to go a lot further.</p>

				<p><img src="assets/images/technology/blog_super.jpg" alt="blog image"></p>

				<h3>Benefits of 5G</h3>

				<p>5G will benefit much more than improving network connection by providing new opportunities, Advancing societies, and Transforming industries especially in the areas of Internet of Things (IoT) virtual reality (VR), and artificial intelligence (AI).</p>

				<ul>
				<li>5G will be up to 100x faster than their precursors.</li>
				<li>Better at handling thousands of devices together.</li>
				<li>Enhanced capacity and increased bandwidth.</li>
				<li>Will reduce latency.</li>
				<li>5G is a unified platform which makes it more capable than 4G.</li>
				</ul>

				<h3>When will 5G be available?</h3>

				<p>5G Networks are already available in major areas of various countries and are expanding which will be commonly available in every country within the end of 2022. Global operators have already started launching 5G networks in some parts in early 2019.</p>

				<p><em>Ronan Dunne CEO and Executive Vice President have said that 5G will enable 12.3 trillion dollars of global economic output and support 22 million jobs worldwide by the year 2035.</em></p>


				<p>Currently, 5G has been deployed in 60+ countries worldwide and is increasing. Compared to 4G, 5G has been rolling out much faster and people are adopting it. 5G provides various benefits to users such as massive IoT and enhanced mobile broadband. All Major players in manufacturing mobile phones are using 5G and soon everyone will get access to it in upcoming days.</p>

				<h3>Conclusion</h3>

				<p>Whatever we do in our lives, <a href="ai.php">Artificial Intelligence</a> and 5G will enable us to do it faster and better. Whether it’s today, tomorrow, or next year, soon you’ll benefit from 5G. It will impact every edge of the industry and make things happen that we never imagined.</p>
