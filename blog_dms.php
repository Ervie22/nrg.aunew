        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo" style="padding-left:50px;">
              <img src="assets/images/nrg.png" alt="nrg" height = 100px width = 100px >
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                  <h3 class="slide-item__title">Digital Marketing Services</h3>
                 </div>
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="assets/images/technology/blog_dms.jpg" alt="" style="border-radius: 50%;">
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="post-item">
              <div class="position-relative">
                <div class="post-item__img">
                  <a href="#">
                    <img src="assets/images/technology/blog_dms.jpg" alt="blog image"  >
                  </a>
                </div><!-- /.post-img -->
              ...
              <div class="post-item__desc">
                <p>Acknowledging digitization is just the initial step toward company success. Enhancing the breadth of your online marketplace is also important. Enjoy the benefits of ROI-driven digital marketing solutions as a result.</p>
              <h3>The primacy of a digital marketing strategy</h3>
                <P>You need to have a robust online presence if you want your firm to remain competitive in today's digital world. And creating an effective digital strategy is the only way to achieve that.</P>
                <P>Your marketing efforts will most likely be dispersed if you don't have a sound digital marketing strategy, which will make your digital marketing campaign less profitable throughout.</P>
                <P>Your enterprise is better ready for success when you have a concrete plan, aim, and target customer in mind. But the most significant factor in achieving this result is using the necessary tools and services, such as those that NRG Phoenix provides!!
</P>
...
<P>By promoting your brand to prospective customers in various demographics, our Google Search Engine Marketing experts will deliver you sharp-end solutions that enhance your brand visibility and increase your leads. We create content that appeals to customers and connects them in a significant manner. Our remedies can easily raise brand awareness by precisely targeting your potential clients on social media.</P>

<h3>SMM – Social Media Marketing</h3>
<P>Businesses are recognizing the value of assessment is made themselves on various channels as social media climbs to become one of the most influential marketing platforms of today. Harnessing the power of social media channels to increase sales, increase engagement, and define your company brand, social media marketing is a convenient marketing tactic.</P>


<h3>Summary</h3>

<P>For clients across a wide range of industries and verticals, NRG Phoenix's team of digital marketing specialists can assist in developing workable solutions. 
 <a href="index.php">For more information
Visit: Digital Marketing Services | Digital Marketing Company in Australia | NRG Phoenix</a></P>
